      ...
      {numPizza > 0 ? (
        <>
          <p>
            ...
            from our stone oven, all orgainic,all delecious.
          </p>
          <ul className="pizzas">
            {pizzaData.map((pizza) => (
        ...
        <p>We are currently working. Please come back later.</p>
      )}
    </div>
  );
}
...
//       <h1 style={style}>My Fast Pizza Co.</h1>;
//     </header>
//   );
// }
// function Menu() {
